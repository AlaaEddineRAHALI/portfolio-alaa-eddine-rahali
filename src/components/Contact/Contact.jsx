...
const Contact = () => {
  ...
  return (
    <>
      <section id="contact" className="section__contact px-5 lg:pt-[1%]">
        <div className=" flex flex-wrap justify-center pb-32 pt-20 sm:pb-48 lg:h-screen lg:items-center lg:py-0 lg:pt-[5%] 2xl:py-0 2xl:pt-[5%]">

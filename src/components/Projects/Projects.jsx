    ...
    <>
      ...
      >
        ...
        <div className="flex flex-wrap justify-start sm:justify-center">
          <article className="flex bg-white transition hover:shadow-xl m-8  w-[100%] h-full  rounded-3xl lg:w-[29%] md:w-[70%]">
              ...
              <div className="flex flex-1 flex-col justify-between">
                <div className="border-s border-gray-900/10 p-4 sm:border-l-transparent sm:p-6">
                  ...
                  <p className="mt-2 text-sm/relaxed text-gray-700 ">
                    ...
                    forcément un site Internet.Actiively est une application qui
                    permet aux organismes de proposer leurs activités et aux
                    utilisateurs d’avoir une plateforme centralisée pour trouver
                    une activitée.
                  </p>
                </div>
